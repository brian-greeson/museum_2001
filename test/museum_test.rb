...
class MuseumTest < Minitest::Test
  ...
  def test_it_can_list_lottery_contestants
    dmns = Museum.new("Denver Museum of Nature and Science")
    gems_and_minerals = Exhibit.new({name: "Gems and Minerals", cost: 0})
    dead_sea_scrolls = Exhibit.new({name: "Dead Sea Scrolls", cost: 10})
    imax = Exhibit.new({name: "IMAX",cost: 15})
  ...
  def test_it_can_annouce_lottery_winner
    dmns = Museum.new("Denver Museum of Nature and Science")
    gems_and_minerals = Exhibit.new({name: "Gems and Minerals", cost: 0})
    dead_sea_scrolls = Exhibit.new({name: "Dead Sea Scrolls", cost: 10})
    imax = Exhibit.new({name: "IMAX",cost: 15})
    ...
    dmns.admit(patron_2)
    dmns.admit(patron_3)
    announcement_message = "Bob has won the Dead Sea Scrolls exhibit lottery"

    assert_equal "No winners for this lottery",
                                dmns.announce_lottery_winner(gems_and_minerals)

    dmns.stubs(:draw_lottery_winner).returns(patron_1)

    assert_equal announcement_message, dmns.announce_lottery_winner(dead_sea_scrolls)
  end
